...
// export const transfer = async (id: string, data: any) => {

//   try {
//     // Extracting receiver address and amount from the request body
//     const wallet = data["receiverAddress"];
...
//     const tx = await cUSDcontract.transfer(wallet, weiTransferAmount).send({ from: user.account.address, feeCurrency: cUSDcontract.address })
